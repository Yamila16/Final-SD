...
</script><title>Banco Vision</title>
...
<div id="modal-wrapper" class="modal">
  ...
  <form class="modal-content animate" action="bancovalida.php" method="POST">
    ...
    <div class="imgcontainer">
      ...
      <h1 style="text-align:center">BANCO VISION</h1>
    </div>
      ...
      <div class="row">
        <div class="col-12">
            <div class="my-3 p-3 bg-white rounded box-shadow box-style">
                <div id="home-box">
                    <div class="content">
                        <h1 style="font-size:x-large; color:black; ">BANCO VISION</h1>
                        <p class="mt-3 text-left"><img src="imagenes/bancolombia.png" width="500" class="img-fluid float-left" alt="LikeFans" >
...
<div class="row">
<div class="col">
<a class="nav-link" onclick="document.getElementById('modal-wrapper').style.display='block'"><button class="btn btn-warning">INGRESAR BANCO VISION</button></a>
</div>
<div class="col">
<a class="nav-link" onclick="document.getElementById('modal2-wrapper').style.display='block'"><button class="btn btn-warning">REGISTRARSE BANCO VISION</button></a>
</div>
 </div>
